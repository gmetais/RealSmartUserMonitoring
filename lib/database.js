            ...
            client.search({
                ...
                if (err) {
                    ...
                    var results = {
                        ...
                        pagesPerVisit: Math.round(resp.aggregations.nbPages.value / resp.hits.total * 100) / 100,
                        bounceRate: Math.round(resp.aggregations.bounce.doc_count / resp.hits.total * 1000) / 10,
